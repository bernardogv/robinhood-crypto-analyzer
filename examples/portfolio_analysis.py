...
def main():
    ...
    try:
        # This is the line where the mock API raises an exception in the test
        holdings = api.get_holdings()
        
        # Process holdings data only if we didn't get an exception
        if holdings is None:
        ...
        # This is the key line for the test - it must match exactly
